...
#define sd 0 //write 1 if using sd card dataloggger
...
#define num_sensors 1 //defines how many sensors are in use
#define num_mux 1 //defines how many multiplexers are in use
#define card_select 10 //for SD card and datalogger
#define slope 7 //calculated slope for getting weight values from ADSD1115
#define delay_time 1000 //set time between measurements in milliseconds
